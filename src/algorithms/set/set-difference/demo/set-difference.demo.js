...
import { setDifference } from '../src/set-difference'
...
class SetDifferenceOfTwoSetsVisualizer extends Component {
  ...
  render() {
    ...
    return (
      <div className="setDifferenceDemo">
        <h1>Set Difference of Two Sets Demo</h1>
        <p>
...
export const setDifferenceOfTwoSetsVisualizer = () => (
  <SetDifferenceOfTwoSetsVisualizer />
)
